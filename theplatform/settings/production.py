...
APP_NAME = env.get('APP_NAME', 'theplatform')
...
if 'LOG_DIR' in env:
    # theplatform log
    LOGGING['handlers']['theplatform_file'] = {
        'level':        'INFO',
        'class':        'cloghandler.ConcurrentRotatingFileHandler',
        'filename':     os.path.join(env['LOG_DIR'], 'theplatform.log'),
        'maxBytes':     5242880,  # 5MB
        'backupCount':  5
    }
    LOGGING['loggers']['wagtail']['handlers'].append('theplatform_file')
